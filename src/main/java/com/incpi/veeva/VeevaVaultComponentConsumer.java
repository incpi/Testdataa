 ...
 */
public class VeevaVaultComponentConsumer extends ScheduledPollConsumer {
    private Logger LOG = LoggerFactory.getLogger(VeevaVaultComponentConsumer.class);

    private final VeevaVaultComponentEndpoint endpoint;


    public VeevaVaultComponentConsumer(final VeevaVaultComponentEndpoint endpoint, final Processor processor) {
