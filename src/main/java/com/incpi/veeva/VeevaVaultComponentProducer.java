 ...
 */
public class VeevaVaultComponentProducer extends DefaultProducer {
    private static final transient Logger LOG = LoggerFactory.getLogger(VeevaVaultComponentProducer.class);
    private VeevaVaultComponentEndpoint endpoint;

	public VeevaVaultComponentProducer(VeevaVaultComponentEndpoint endpoint) {
        super(endpoint);
